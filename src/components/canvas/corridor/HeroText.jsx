 ...
 * - SAMFIP in Rubik Scribble font (splits into letters during scroll)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for SAMFIP split effect
    const letters = useMemo(() => [
        { char: 'S', baseX: -1.05, splitDir: -1.8, delay: 0 },
        { char: 'A', baseX: -0.63, splitDir: -1.1, delay: 0 },
        { char: 'M', baseX: -0.19, splitDir: -0.4, delay: 0 },
        { char: 'F', baseX: 0.23, splitDir: 0.4, delay: 0 },
        { char: 'I', baseX: 0.57, splitDir: 1.1, delay: 0 },
        { char: 'P', baseX: 0.95, splitDir: 1.8, delay: 0 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -1.0, splitDir: -1.5, delay: 0 },
        { text: 'software', baseX: -0.45, splitDir: -0.8, delay: 0 },
        { text: 'engineer', baseX: 0.45, splitDir: 0.8, delay: 0 },
        { text: '/>', baseX: 1.0, splitDir: 1.5, delay: 0 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of SAMFIP
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]}>
            {/* SAMFIP Letters - Rubik Scribble font with fade-in animation */}
