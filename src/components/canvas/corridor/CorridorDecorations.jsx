...
const CorridorDecorations = ({ segmentLength, zOffset, corridorWidth = 4, corridorHeight = 3.5, zClip = 100000, setCameraOverride }) => {
    ...
    const frames = useMemo(() => [
        ...
        },
        {
            ...
            y: 0.25,
            id: 'frame-3',
            // Nimsdai painting, generated by scripts/make_nims_painting.js (sketch -> colour on hover)
            image: '/textures/corridor/nims.webp',
            imagePainted: '/textures/corridor/nims_painted.webp',
            imageWidth: 1.98,
            imageHeight: 0.94,
            offsetFromWall: 0.1
        },
