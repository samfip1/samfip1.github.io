...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const handleMailSelect = () => {
        ...
        window.location.href = 'mailto:samantrathod6@gmail.com';
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/samantrathod/', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GITHUB"
                onClick={() => window.open('https://github.com/samfip1', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* LEETCODE */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="LEETCODE"
                onClick={() => window.open('https://leetcode.com/u/Cheeku20', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* CODECHEF */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="CODECHEF"
                onClick={() => window.open('https://www.codechef.com/users/samfip1', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* CODEFORCES */}
            <SocialBarrel
                position={isMobile ? [0, 0.6, -12] : [0, 0.6, -12]}
                rotation={[0, 0, 0]}
                texturePath="/textures/contact/beczka.webp"
                label="CODEFORCES"
                onClick={() => window.open('https://codeforces.com/profile/samfip.work', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
