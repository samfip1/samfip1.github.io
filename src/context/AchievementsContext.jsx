...
export const ACHIEVEMENTS = {
    ...
    studio_interact: { id: 'studio_interact', label: 'Drag to spin. That\'s all there is.', title: 'Director' },
...
export const AchievementsProvider = ({ children }) => {
    ...
    const [completed, setCompleted] = useState(() => {
        try {
            const saved = localStorage.getItem('samfip_achievements');
            if (saved) {
    ...
    useEffect(() => {
        ...
        localStorage.setItem('samfip_achievements', JSON.stringify(toSave));
    }, [completed]);
